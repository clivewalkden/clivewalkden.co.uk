  ...
  <div class="w-full">
    ...
    >
      ...
      <input
          ...
          v-model="query"
          ref="search"
          class="relative block h-10 w-full lg:focus:w-3/4 bg-gray-100 border border-gray-500 focus:border-blue-400 outline-none cursor-pointer text-gray-700 px-4 pb-0 pt-px transition-all duration-200 ease-out"
      ...
      <transition name="fade">
        <div v-if="query" class="absolute left-0 right-0 md:inset-auto w-full text-left mb-4 md:mt-10">
          <div
              class="flex flex-col bg-white border border-b-0 border-t-0 border-blue-400 rounded-b-lg shadow-search mx-4 md:mx-0">
            <a
            ...
            >
              ...
              <span class="block font-normal text-gray-700 text-sm my-1" v-html="result.item.intro"></span>
            </a>
