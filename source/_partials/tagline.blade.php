<div class="relative flex flex-col-reverse py-16 lg:pt-0 lg:flex-col lg:pb-0">
    <div class="inset-y-0 top-0 right-0 z-0 w-full max-w-xl px-4 mx-auto md:px-0 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-7/12 lg:max-w-full lg:absolute xl:px-0">
        ...
        <img
                ...
                src="/assets/images/website-code.jpg"
                alt=""
        />
    </div>
    <div class="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
        <div class="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
            ...
            <p class="pr-5 mb-5 text-base text-title md:text-lg">
                I'm the CTO for <a href="http://sozodesign.co.uk" title="SOZO Design Cheltenham" target="_blank" class="text-primary">SOZO Design</a> in Cheltenham, UK. I also build Magento 2 sites and other PHP projects. View my <a href="/code/" class="text-primary">Magento 2 modules</a> and <a href="/code/" class="text-primary">jQuery plugins</a>.
            </p>
