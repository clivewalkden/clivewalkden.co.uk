        ...
        <div class="grid gap-10 lg:grid-cols-2">
            <div class="lg:pr-10">
                ...
                <div class="flex items-center space-x-4">
                    <a href="/" class="text-gray-600 transition-colors duration-300 hover:text-yellow-400">
